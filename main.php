        ...
        <div class="sidebar">
            ...
            <div class="events">
                ...
                if(isset($_POST['goto-btn'])){
                    ...
                    <div class="nec-btns">
                    <div class="stat" onclick="location.href='editstat.php?id=<?= $row2['TaskID']; ?>';"><?php echo $sdes; ?></div>  
                    <div class="edit-btn"><button onclick="location.href='edit.php?id=<?= $row2['TaskID']; ?>';"><i class="fa-solid fa-pen"></i></button></div>
                    <div class="del-btn"><button onclick="location.href='delete.php?id=<?= $row2['TaskID']; ?>';"><i class="fa fa-trash" aria-hidden="true"></i></button></div>
                    </div>
                    </div>
                    <?php
                    }
                ...
                if(isset($_POST['filter-btn'])){
                    ...
                    <div class="nec-btns">
                    <div class="stat" onclick="location.href='editstat.php?id=<?= $row2['TaskID']; ?>';"><?php echo $sdes; ?></div>
                        <div class="edit-btn"><button onclick="location.href='edit?id=<?= $row3['TaskID']; ?>';"><i class="fa-solid fa-pen"></i></button></div>
                        <div class="del-btn"><button onclick="location.href='delete.php?id=<?= $row3['TaskID']; ?>';"><i class="fa fa-trash" aria-hidden="true"></i></button></div>
                    </div>
                    </div>
                    <?php
                    }
