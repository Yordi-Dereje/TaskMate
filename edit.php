...
<head>
    ...
    <link rel="stylesheet" href="styles/new.css?version2" />
    <link rel="stylesheet" href="themeChanger.css?version2" />
  ...
  <div class="sidespace">
    ...
    <div class="form-box">
      ...
      <select name="category" id="category" required>
        ...
        <option value="work" <?php if ($task_data['Category'] == 'work') echo 'selected="selected"'?> >Work</option>
        <option value="religion" <?php if ($task_data['Category'] == 'religion') echo 'selected="selected"'?> >Religion</option>
